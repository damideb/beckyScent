...
export default function Services() {
  ...
  return (
    <div className=' m-4 mt-10  p-3 ' id='services'>
    ...
    <div className='w-[90%] sm:w-[80%] my-2 mx-auto'>
      <div className='block sm:flex gap-5 mb-14 mt-6 justify-between' data-aos='fade-left'>
        ...
        <div className='m-2'>
          <h2 className='text-[1.2rem] sm:text-[1.5rem] p-1 font-[500]'>Fragrance</h2>
      ...
      <div className=' block sm:flex gap-5 my-14 justify-between sm:flex-row-reverse' data-aos='fade-left'>
        ...
        <div className='m-2'>
          <h2 className='text-[1.2rem] sm:text-[1.5rem] p-1 font-[500]'>Gift Curation</h2>
      ...
      <div className='block sm:flex gap-5 my-14 justify-between' data-aos='fade-right'>
        ...
        <div className='m-2'>
          <h2 className='text-[1.2rem] sm:text-[1.5rem] p-1 font-[500]'>Jelwries & Accesories</h2>

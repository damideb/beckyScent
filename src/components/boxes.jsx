...
export default function Boxes(){
    return(
          ...
          <div className='bg-white h-[22em] basis-[30%] shadow-lg p-6 text-center drop-shadow-xl rounded'>
            ...
            <div className=' bg-light w-[4em] h-[4em] p-2 rounded-[50%] m-auto animate-bounce '><TbTruckDelivery className='text-[3rem] text-100 p-2 text-center'/></div>
          ...
          <div className='bg-white h-[25em] basis-[30%] shadow-lg p-6 text-center drop-shadow-xl -mt-9 rounded'>
            ...
            <div className=' bg-light w-[4em] h-[4em] p-2 rounded-[50%] m-auto animate-pulse '><MdOutlineProductionQuantityLimits className='text-[3rem] text-100 p-2 text-center'/></div>
          ...
          <div className='bg-white h-[22em] basis-[30%] shadow-lg p-6 text-center drop-shadow-xl rounded'>
            ...
            <div className=' bg-light w-[4em] h-[4em] p-2 rounded-[50%] m-auto animate-pulse '><GiMoneyStack className='text-[3rem] text-100 p-2 text-center'/></div>
